...
class HttpRouterGateway:
    ...
    Mesmo padrão de re-injeção interna do u2: POST autenticado por
    `X-Internal-Secret` para o endpoint de inbound-text. Desacoplado: nenhum
    import de internals de `apps/conversation-router`.
    """
